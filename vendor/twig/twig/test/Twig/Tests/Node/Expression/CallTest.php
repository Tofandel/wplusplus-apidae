...
class Twig_Tests_Node_Expression_CallTest extends \PHPUnit\Framework\TestCase {
	public function testGetArguments() {
		...
		$this->assertEquals( array( 'U', null ), $this->getArguments( $node, array(
			'date',
			array( 'format' => 'U', 'timestamp' => null )
		) ) );
	}
	...
	public function testGetArgumentsWithWrongNamedArgumentNames() {
		$node = new Twig_Tests_Node_Expression_Call( array(), array( 'type' => 'function', 'name' => 'date' ) );
		$this->getArguments( $node, array(
			'date',
			array( 'Y-m-d', 'timestamp' => null, 'unknown1' => '', 'unknown2' => '' )
		) );
	}
	...
	public function testResolveArgumentsWithMissingValueForOptionalArgument() {
		...
		$this->getArguments( $node, array(
			'substr_compare',
			array( 'abcd', 'bc', 'offset' => 1, 'case_sensitivity' => true )
		) );
	}
	...
	public function testResolveArgumentsOnlyNecessaryArgumentsForCustomFunction() {
		...
		$this->assertEquals( array( 'arg1' ), $this->getArguments( $node, array(
			array( $this, 'customFunction' ),
			array( 'arg1' => 'arg1' )
		) ) );
	}
	...
	public function testGetArgumentsForStaticMethod() {
		...
		$this->assertEquals( array( 'arg1' ), $this->getArguments( $node, array(
			__CLASS__ . '::customStaticFunction',
			array( 'arg1' => 'arg1' )
		) ) );
	}
